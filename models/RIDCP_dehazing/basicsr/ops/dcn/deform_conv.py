'''
Roy:  to solve: RIDCP_dehazing/basicsr/ops/dcn/deform_conv.py", line 149, in forward
    deform_conv_ext.modulated_deform_conv_forward(input, weight, bias, ctx._bufs[0], offset, mask, output,
NameError: name 'deform_conv_ext' is not defined. Did you mean: 'deform_conv'?

set up env of BASICSR_JIT
option1： in this py file, add: os.environ['BASICSR_JIT'] = 'True'
option2: in terminal, run export BASICSR_JIT=True
...
os.environ['BASICSR_JIT'] = 'True'  ### Roy
