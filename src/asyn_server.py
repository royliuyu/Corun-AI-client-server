...
# cnt = 0
#
# def handle(conn, addr): ## recv_send  between clinets, one turn of data transfer+ result back
#     reply =''
#     previous_model = ''
...
#             data_in_row = [work_start, model_name, args['train_model_name'], args['image_size'], device,
#                            args['file_name'], latency]
#             logger_prefix = 'infer_log_server_' + str(args['request_rate']) + 'rps_' + ' train_' + args[
#                 'train_model_name'] + '+infer_' + model_name + '_'
...
#
#
# def work(ip,port): # multi thread processing
#     global cnt
#     print(ip,port)
...
#         #     thd = threading.Thread(target = handle, args =(conn, addr))
#         #     thd.start()
#         #     data_in_row, logger_prefix = thd.get_result()
#         #     log = log.append(data_in_row)
#         # except:
#         #     print(log)
#         #     # log.to_csv(os.path.join(log_dir, logger_prefix, '.csv'))
#
#
# if __name__ =='__main__':
#     # ip, port = '192.168.85.71', 51400
#     # ip , port = '128.226.119.71', 51400
#     # ip, port = '0.0.0.0', 51401
#     ip, port = '0.0.0.0', 51400
#     work(ip, port)